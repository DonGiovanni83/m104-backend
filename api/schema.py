...
from api.types.firma.mutation import CreateFirmaMutation
...
from api.types.schueler.mutation import CreateSchuelerMutation
...
class Mutation(graphene.ObjectType):
    ...
    create_firma = CreateFirmaMutation.Field()
    create_schueler = CreateSchuelerMutation.Field()
